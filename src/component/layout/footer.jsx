                                ...
                                <div className="footer-top-item lab-item">
                                    <div className="lab-inner">
                                        ...
                                        <div className="lab-content">
                                            <span>Phone Number : +92 300 xxxxxxx</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 col-sm-6 col-12">
                                <div className="footer-top-item lab-item">
                                    <div className="lab-inner">
                                        ...
                                        <div className="lab-content">
                                            <span>Email : jawad@gmail.com</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="col-lg-4 col-sm-6 col-12">
                                <div className="footer-top-item lab-item">
                                    <div className="lab-inner">
                                        ...
                                        <div className="lab-content">
                                            <span>Address : Gulberg 333 Lahore</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="footer-bottom-content text-center">
                                    <p>&copy;2026 <Link to="/">BiGamer</Link> - eSpost And Gameing by Jawad Naseer</p>
                                </div>
                            </div>
                        </div>
                    </div>
